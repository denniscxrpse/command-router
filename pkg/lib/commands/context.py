...
from pkg.utils import Status, flags
...
class ParseError:
    ...
    def _get_suggestions(self) -> list[str] | None:
        ...
        if flags.no_suggestions:
            return None
        try:
            from pkg.lib.control.api.fixtures_sdk import FixturesSetup

            limit = FixturesSetup._resolve_suggestions_limit()
        except Exception:
            from pkg.utils.cli import flags as _flags
            from pkg.utils.context import uctx as _uctx
