...
from pkg.lib.control.compiler import _compile_grammars, _GrammarSource, _GrammarSyntaxError
from pkg.lib.control.fixture_loader import _load_fixture_module
from pkg.utils import Status, flags, log, log_handler, stat
...
class _Control:
    ...
    def _initialize_fixture(
        ...
        ``pkg.sdk``) bypass module loading entirely.  The instance is
