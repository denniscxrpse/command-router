...
from command_router.suggestions.algo import fuzzy_str_match
from command_router.utils import LazyServer, Status, flags, log, stat, uctx

from .context import lazy_suggest_srv_ctx

if TYPE_CHECKING:
    from command_router.lib.commands.context import ParseError
...
class LazySuggestionsServer(LazyServer):
    ...
    def _compute_suggestions(command_text: str) -> tuple[list[str] | None, Status | None]:
        ...
        try:
            ...
            from command_router.lib.control.api.control import control as _shared_control
