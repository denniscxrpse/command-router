...
from command_router.utils import Status, flags
...
class ParseError:
    ...
    def _get_suggestions(self) -> list[str] | None:
        ...
        try:
            ...
            from command_router.utils.cli import flags as _flags
            from command_router.utils.context import uctx as _uctx
